...
! function() {
    ...
    d = /Android/.test(ce), a = (a = !(i = /WebKit/.test(ce)) && /MSIE/gi.test(ce) && /Explorer/gi.test(se.appName)) && /MSIE (\w+)\./.exec(ce)[1], u = -1 !== ce.indexOf("Trident/index.html") && (-1 !== ce.indexOf("rv:") || -1 !== se.appName.indexOf("Netscape")) && 11, s = -1 !== ce.indexOf("Edge/index.html") && !a && !u && 12, a = a || u || s, c = !i && !u && /Gecko/.test(ce), l = -1 !== ce.indexOf("Mac"), f = /(iPad|iPhone)/.test(ce), m = "FormData" in window && "FileReader" in window && "URL" in window && !!ue.createObjectURL, g = le("only screen and (max-device-width: 480px)") && (d || f), p = le("only screen and (min-width: 800px)") && (d || f), h = -1 !== ce.indexOf("Windows Phone"), s && (i = !1);
    ...
    var Sn = function(n) {
        ...
        Xn = [{
            ...
            search: function(e) {
                return jn(e, "edge/index-2.html") && jn(e, "chrome") && jn(e, "safari") && jn(e, "applewebkit")
            }
        }, {
            name: "Chrome",
            ...
            search: function(e) {
                return (jn(e, "safari") || jn(e, "mobile/index.html")) && jn(e, "applewebkit")
            }
        }],
        Yn = [{
            name: "Windows",
    ...
    function ni(i) {
        ...
        return i.valid_elements ? y(i.valid_elements) : (Yo(n, function(e, t) {
            ...
            e = Zo(e, "index.html"), N[e[1]].outputName = e[0]
        ...
        var r = this,
            ...
            f = function(e, t, n, r, o) {
                if (!a[e]) {
                    ...
                    0 !== i.indexOf("index.html") && -1 === i.indexOf("://") && (i = Ni.baseURL + "/" + i), a[e] = i.substring(0, i.lastIndexOf("index.html")), u[e] ? l(e, t, n, r) : Ci.ScriptLoader.add(i, function() {
                        return l(e, t, n, r)
                    }, r, o)
                }
            };
    ...
    var Kp = function(e) {
        ...
        Yp = function(e) {
            return 0 === e.indexOf("blob:") ? (i = e, new De(function(e, t) {
                ...
                try {
                    var r = new qp;
                    r.open("GET.html", i, !0), r.responseType = "blob", r.onload = function() {
            ...
            parse: function(e) {
                ...
                for (S = new RegExp("<(?:(?:!--([\\w\\W]*?)--\x3e)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([A-Za-z][A-Za-z0-9\\-_\\:\\.]*)>)|(?:([A-Za-z][A-Za-z0-9\\-_\\:\\.]*)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), T = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, s = U.getShortEndedElements(), E = F.self_closing_elements || U.getSelfClosingElements(), g = U.getBoolAttrs(), p = F.validate, u = F.remove_internals, _ = F.fix_self_closing, k = U.getSpecialElements(), N = e + ">"; t = S.exec(N);) {
                    if (R < t.index && q(O(e.substr(R, t.index - R))), n = t[6]) ":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), I(n);
                        ...
                        c || (v && v.indexOf("index.html") === v.length - 1 ? f && j(n) : D.push({
                            name: n,
                            valid: f
                        }))
    ...
    var ZC = function(e) {
        ...
        Ex = function(r, e) {
            ...
            if (r = xx(r), t = (e = o.settings = e || {}).base_uri, /^([\w\-]+):([^\/]{2})/i.test(r) || /^\s*#/.test(r)) o.source = r;
                ...
                var i = 0 === r.indexOf("//");
                0 !== r.indexOf("index.html") || i || (r = (t && t.protocol || "http") + "://mce_host" + r), /^[\w\-]*:?\/\//.test(r) || (n = e.base_uri ? e.base_uri.path : new Ex(document.location.href).directory, "" == e.base_uri.protocol ? r = "//mce_host" + o.toAbsPath(n, r) : (r = /([^#?]*)([#?]?.*)/.exec(r), r = (t && t.protocol || "http") + "://mce_host" + o.toAbsPath(n, r[1]) + r[2])), r = r.replace(/@@/g, "(mce_at)"), r = /^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@\/]*):?([^:@\/]*))?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/.exec(r), Cx(wx, function(e, t) {
                    var n = r[t];
    ...
    Ex.prototype = {
        ...
        toRelPath: function(e, t) {
            var n, r, o, i = 0,
                a = "";
            if (e = (e = e.substring(0, e.lastIndexOf("index.html"))).split("index.html"), n = t.split("index.html"), e.length >= n.length)
                for (r = 0, o = e.length; r < o; r++)
            ...
            if (1 === i) return t;
            for (r = 0, o = e.length - (i - 1); r < o; r++) a += "index.html";
        ...
        toAbsPath: function(e, t) {
            var n, r, o, i = 0,
                a = [];
            for (r = /\/$/.test(t) ? "/" : "", e = e.split("index.html"), t = t.split("index.html"), Cx(e, function(e) {
                    e && a.push(e)
                }), e = a, n = t.length - 1, a = []; 0 <= n; n--) 0 !== t[n].length && "." !== t[n] && (".." !== t[n] ? 0 < i ? i-- : a.push(t[n]) : i++);
            return 0 !== (o = (n = e.length - i) <= 0 ? a.reverse().join("index.html") : e.slice(0, n).join("index.html") + "/" + a.reverse().join("index.html")).indexOf("index.html") && (o = "/" + o), r && o.lastIndexOf("index.html") !== o.length - 1 && (o += r), o
        },
        getURI: function(e) {
            var t, n = this;
        ...
        var t;
        return t = 0 !== e.protocol.indexOf("http") && "file:" !== e.protocol ? e.href : e.protocol + "//" + e.host + e.pathname, /^[^:]+:\/\/\/?[^\/]+\//.test(t) && (t = t.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, ""), /[\/\\]$/.test(t) || (t += "index.html")), t
    };
    ...
    iw(Hx = {
        ...
        setup: function() {
            var e, t, n, r, o = "";
            if (t = Ex.getDocumentBaseUrl(document.location), /^[^:]+:\/\/\/?[^\/]+\//.test(t) && (t = t.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, ""), /[\/\\]$/.test(t) || (t += "index.html")), n = window.tinymce || window.tinyMCEPreInit) e = n.base || n.baseURL, o = n.suffix;
            else {
                for (var i = document.getElementsByTagName("script"), a = 0; a < i.length; a++) {
                    var u = (r = i[a].src).substring(r.lastIndexOf("index.html"));
                    if (/tinymce(\.full|\.jquery|)(\.min|\.dev|)\.js/.test(r)) {
                        -1 !== u.indexOf(".min") && (o = ".min"), e = r.substring(0, r.lastIndexOf("index.html"));
                        break
                    }
                }!e && document.currentScript && (-1 !== (r = document.currentScript.src).indexOf(".min") && (o = ".min"), e = r.substring(0, r.lastIndexOf("index.html")))
            }
                ...
                e = function() {
                    ...
                    nw.unbind(window, "ready", e),
                        function(e) {
                            ...
                            var e, n = [];
                            if (Re.ie && Re.ie < 11) return Up("TinyMCE%20does%20not%20support%20the%20browser%20you%20are%20using.%20For%20a%20list%20of%20supported%20browsers%20please%20see_%20https_/www.tinymce.com/docs/get-started/system-requirements/index.html"), [];
